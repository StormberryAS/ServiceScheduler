;(function () {
  ...
  const COUNTRIES = ['Norway','United Kingdom','Netherlands','Brazil','United Arab Emirates','Angola','Australia','Syria','Poland','Philippines','India'];
  const VISATYPES = ['Temporary work permit','Business visitor','Residence permit'];
  const settings = () => ({
  ...
  const engineers = () => ([
    ...
    { id:'e01', name:'Lars Pedersen', nationalities:['Norway'],
      passports:[{country:'Norway',number:'NO11111',expiry:'2031-04-01'}], visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2028-01-01'}],
    ...
    { id:'e02', name:'Ingrid Solheim', nationalities:['Norway'],
      passports:[{country:'Norway',number:'NO22222',expiry:'2030-06-01'}], visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2027-09-01'}],
    ...
    { id:'e03', name:'Tom Eriksen', nationalities:['Norway'],
      passports:[{country:'Norway',number:'NO33333',expiry:'2026-10-01'}], visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2027-01-01'}],
    ...
    { id:'e04', name:'Sofia Haugen', nationalities:['Norway'],
      passports:[{country:'Norway',number:'NO44444',expiry:'2031-01-01'}], visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2028-01-01'}],
    ...
    { id:'e06', name:'Nora Berg', nationalities:['Norway'],
      passports:[{country:'Norway',number:'NO66666',expiry:'2031-01-01'}], visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2028-01-01'}],
      certs:[
    ...
    { id:'e07', name:'Mateus Almeida', nationalities:['Brazil'], passports:[{country:'Brazil',number:'BR70000',expiry:'2029-03-01'}],
      visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2027-05-01'},{country:'Norway',type:'Residence permit',expiry:'2027-05-01'},{country:'Norway',type:'Residence permit',expiry:'2027-08-01'}], certs:baseCerts('2027-10-01'),
    ...
    { id:'e08', name:'Wouter Smit', nationalities:['Netherlands'], passports:[{country:'Netherlands',number:'NL80000',expiry:'2030-09-01'}],
      visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2028-01-01'},{country:'Norway',type:'Residence permit',expiry:'2031-03-01'}], certs:baseCerts('2028-02-01'),
    ...
    { id:'e09', name:'Aisha Rahman', nationalities:['United Kingdom','Syria'],
      ...
      visas:[{country:'Norway',type:'Residence permit',expiry:'2027-11-01'}], certs:baseCerts('2027-12-01'), competence:[comp('lifeboat/davit system','overhaul and recertification (including load test)',2)],
      availability:{ lastOffshore:null, restDaysOverride:null, vacations:[] },
      assignments: [] },
    { id:'e10', name:'Kari Nilsen', nationalities:['Norway'], passports:[{country:'Norway',number:'NO10000',expiry:'2029-11-01'}],
      visas:[{country:'Angola',type:'Temporary work permit',expiry:'2027-03-01'}], certs:baseCerts('2027-04-01'),
    ...
    { id:'e11', name:'Diego Santos', nationalities:['Brazil'], passports:[{country:'Brazil',number:'BR11000',expiry:'2028-07-01'}],
      visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2027-02-01'},{country:'Norway',type:'Residence permit',expiry:'2032-06-01'}], certs:baseCerts('2027-03-01'),
    ...
    { id:'e12', name:'Elena Costa', nationalities:['Brazil','United Kingdom'],
      ...
      visas:[{country:'Norway',type:'Residence permit',expiry:'2027-06-01'}], certs:baseCerts('2028-01-01'), competence:[comp('lifeboat/davit system','preventive (scheduled) service',3)],
    ...
    { id:'e13', name:'Henrik Dahl', nationalities:['Norway'], passports:[{country:'Norway',number:'NO13000',expiry:'2027-02-15'}],
      visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2028-01-01'}], certs:baseCerts('2027-07-01'),
    ...
    { id:'e14', name:'Liam Murphy', nationalities:['United Kingdom'], passports:[{country:'United Kingdom',number:'UK14000',expiry:'2031-06-01'}],
      visas:[{country:'Norway',type:'Residence permit',expiry:'2028-01-01'},{country:'Norway',type:'Residence permit',expiry:'2031-09-01'}], certs:baseCerts('2028-03-01'),
    ...
    { id:'e15', name:'Mia Johansen', nationalities:['Norway'], passports:[{country:'Norway',number:'NO15000',expiry:'2030-12-01'}],
      visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2027-11-01'}], certs:baseCerts('2027-09-01'),
      competence:[comp('offshore crane','preventive (scheduled) service',1), comp('lifeboat/davit system','corrective (breakdown) repair',2)],
      availability:{ lastOffshore:null, restDaysOverride:null, vacations:[] },
      assignments: [] },
    // 16. still resting at the job start -> overtime flag in the shortlist (eligible, NOT double-booked): the rest-cost demo case
    { id:'e16', name:'Magdalena Kowalska', nationalities:['Poland'],
      passports:[{country:'Poland',number:'PL16000',expiry:'2030-05-01'}],
      visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2027-06-20'}],
      certs:baseCerts('2028-04-01'), competence:[comp('winch system','overhaul and recertification (including load test)',3)],
      availability:{ lastOffshore:{ end:'2026-07-18', durationDays:21 }, restDaysOverride:null, vacations:[] },
      assignments: [] },
    // 17. available, foreign; Norway permit renews mid-2027 (compliance-calendar variety)
    { id:'e17', name:'Carlos Mendoza', nationalities:['Philippines'],
      passports:[{country:'Philippines',number:'PH17000',expiry:'2029-08-01'}],
      visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2028-03-01'},{country:'Norway',type:'Residence permit',expiry:'2027-07-15'}],
      certs:baseCerts('2028-06-01'), competence:[comp('hydraulic power unit (HPU) / control system','corrective (breakdown) repair',3)],
      availability:{ lastOffshore:{ end:'2026-05-10', durationDays:12 }, restDaysOverride:null, vacations:[] },
      assignments: [] },
    // 18. available now, foreign; UK permit renews mid-2027 (compliance-calendar variety)
    { id:'e18', name:'Priya Sharma', nationalities:['India'],
      passports:[{country:'India',number:'IN18000',expiry:'2030-02-01'}],
      visas:[{country:'United Kingdom',type:'Temporary work permit',expiry:'2027-06-25'}],
      certs:baseCerts('2028-09-01'), competence:[comp('Launch and Recovery System (LARS)','corrective (breakdown) repair',3)],
      availability:{ lastOffshore:null, restDaysOverride:null, vacations:[] },
      assignments: [] },
