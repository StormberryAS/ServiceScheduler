;(function () {
  ...
  const engineers = () => ([
    ...
    { id:'e07', name:'Mateus Almeida', nationalities:['Brazil'], passports:[{country:'Brazil',number:'BR70000',expiry:'2029-03-01'}],
      visas:[{country:'United Kingdom',type:'Work (Service Supplier visa)',expiry:'2027-05-01'},{country:'Norway',type:'Work (residence permit)',expiry:'2027-05-01'}], certs:allCerts('2027-10-01'),
    ...
    { id:'e08', name:'Wouter Smit', nationalities:['Netherlands'], passports:[{country:'Netherlands',number:'NL80000',expiry:'2030-09-01'}],
      visas:[{country:'United Kingdom',type:'Work (Service Supplier visa)',expiry:'2028-01-01'}], certs:allCerts('2028-02-01'),
    ...
    { id:'e11', name:'Diego Santos', nationalities:['Brazil'], passports:[{country:'Brazil',number:'BR11000',expiry:'2028-07-01'}],
      visas:[{country:'United Kingdom',type:'Work (Service Supplier visa)',expiry:'2027-02-01'}], certs:allCerts('2027-03-01'),
    ...
    { id:'e14', name:'Liam Murphy', nationalities:['United Kingdom'], passports:[{country:'United Kingdom',number:'UK14000',expiry:'2031-06-01'}],
      visas:[{country:'Norway',type:'Work (residence permit)',expiry:'2028-01-01'}], certs:allCerts('2028-03-01'),
